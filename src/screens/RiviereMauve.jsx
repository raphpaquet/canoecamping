...
export default function RiviereMauve(props) {

  let content = {
    English: {
      seoTitle: "Riviere Mauve Outaouais",
      description: "Description of the Riviere Mauve in Pontiac, Outaouais",
      riverDescription: ""
    },
    French: {
      seoTitle: "Riviere Mauve Outaouais",
      description: "Descriptif de la Riviere Mauve dans Pontiac, Outaouais",
      riverDescription: ""
    }
  }
